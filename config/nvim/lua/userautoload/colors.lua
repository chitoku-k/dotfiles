...
vim.api.nvim_set_hl(0, 'CursorIM', { bg = '#4682b4' })
...
vim.api.nvim_set_hl(0, 'DiffLine', { bg = '#8fa1b3' })
vim.api.nvim_set_hl(0, 'EndOfBuffer', { fg = '#363d45' })
vim.api.nvim_set_hl(0, 'Flashy', { bg = '#13354a' })
vim.api.nvim_set_hl(0, 'Identifier', { fg = '#c0c5ce' })
vim.api.nvim_set_hl(0, 'qfError', { fg = '#bf616a' })
vim.api.nvim_set_hl(0, 'SignatureMarkerText', { fg = '#bf616a', bg = '#343d46' })
vim.api.nvim_set_hl(0, 'SignatureMarkText', { fg = '#a3be8c', bg = '#343d46' })
vim.api.nvim_set_hl(0, 'SignColumn', { fg = '#65737e', bg = '#343d46' })
vim.api.nvim_set_hl(0, 'SpellBad', { fg = '#bf616a', sp = '#bf616a', undercurl = true })
